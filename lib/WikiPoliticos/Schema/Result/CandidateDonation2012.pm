use utf8;
package WikiPoliticos::Schema::Result::CandidateDonation2012;
...
__PACKAGE__->table("candidates_donations_2012");
__PACKAGE__->add_columns(
  "id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "candidates_donations_2012_id_seq",
  },
  "data_hora",
  {
    data_type   => "text",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7C5Q8lIE1AFniHZvmGBMlQ
