use utf8;
package WikiPoliticos::Schema::Result::CommitteeDonation2014;
...
__PACKAGE__->table("committees_donations_2014");
__PACKAGE__->add_columns(
  "id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "committees_donations_2014_id_seq",
  },
  "eleicao_codigo",
  {
    data_type   => "text",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ymM2R53eB/Hy0CTZDcQgfg
